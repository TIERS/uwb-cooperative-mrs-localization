...
class UWBParticleFilter(Node) :
    ...
    def __init__(self) :
        ...
        self.spatial_subs = [
            self.create_subscription(SpatialDetection, "/turtle0{}/color/yolov4_Spatial_detections".format(t), 
    ...
    def update_filter(self) :
        ...
        #             for 
        #             vis_meas = self.update_range_from_object_pose()
