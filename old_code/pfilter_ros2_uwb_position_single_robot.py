...
class UWBParticleFilter(Node) :
    ...
    def __init__(self) :
        ...
        # Create filter
        self.prior_fn = lambda n: np.random.uniform(-8,2,(n,2))
        print(self.prior_fn)
    ...
    def calc_hypothesis(self, x) :
        ...
        # print(f"y:{y.shape}")
        # self.uwb34_range, self.uwb37_range, self.uwb47_range, self.uwb35_range, self.uwb45_range, self.uwb75_range
        # y = []
