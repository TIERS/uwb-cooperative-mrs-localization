...
class UWBParticleFilter(Node) :
    ...
    def __init__(self) :
        ...
        self.doom_end_sub = self.create_subscription(Odometry, "/turtle01/odom",  self.update_odometry_end_cb, qos_profile=self.qos)
    ...
    def plot_particles(self):
        ...
        # plt.legend()
        self.counter += 1
        plt.savefig("images/test{}.png".format(self.counter))
    ...
    def update_filter(self) :
        ...
        print("Real dist: {}".format(np.linalg.norm(self.true_relative_pose)))
        print("Meas: {}\n".format(new_meas))
