...
class UWBParticleFilter(Node) :
    ...
    def __init__(self) :
        ...
        # Create filter
        self.prior_fn = lambda n: np.random.uniform(-8,5,(n,8))
    ...
    def update_filter(self) :
        ...
        # print(f"------ last: {self.last_turtles_odoms[2].pose.pose.position.x}" )
        self.last_turtles_odoms = np.copy(self.turtles_odoms)
        # print(f"------ now: {self.turtles_odoms[2].pose.pose.position.x}")
        # print("here --------------------")
