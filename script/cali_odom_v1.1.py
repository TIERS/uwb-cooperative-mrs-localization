...
class CalibrateOdom(Node) :
    ...
    def update_turtle01_odom_cb(self, odom):
        ...
        new_turtle01_odom = copy.deepcopy(odom)
        new_turtle01_odom.pose.pose.position.x = -odom.pose.pose.position.y
        new_turtle01_odom.pose.pose.position.y = odom.pose.pose.position.x
    ...
    def update_turtle03_odom_cb(self, odom):
        ...
        new_turtle03_odom = copy.deepcopy(odom)
        new_turtle03_odom.pose.pose.position.x = -odom.pose.pose.position.y
        new_turtle03_odom.pose.pose.position.y = odom.pose.pose.position.x
    ...
    def update_turtle04_odom_cb(self, odom):
        ...
        new_turtle04_odom = copy.deepcopy(odom)
