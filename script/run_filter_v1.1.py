...
for i in [0,2]:
    ...
    for r in tqdm.tqdm(range(num_rounds)):
        ...
        time.sleep(0.1)
        p1 = sp.Popen(["python", "pfilter_ros2_uwb_position_multi_robots_v1.3.6.py", "--fuse_group", "{}".format(i), "--round", "{}".format(r)], stdout=sp.PIPE, stderr=sp.STDOUT)

        p2 = sp.Popen(["python", "triangulation_ros2_uwb_position_v1.1.py", "--round", "{}".format(r)], stdout=sp.PIPE, stderr=sp.STDOUT)
        if os.path.exists("./result_bags/result_bag_{}_{}".format(i, r)):
            shutil.rmtree("./result_bags/result_bag_{}_{}".format(i, r)) 
        p3 = sp.Popen(["ros2", "bag", "record",  "/tri_turtle01_pose", "/tri_turtle03_pose", "/tri_turtle04_pose", "/real_turtle01_pose", "/real_turtle03_pose",
                 "/real_turtle04_pose", "/real_turtle05_pose", "/pf_turtle01_pose","/pf_turtle03_pose", "/pf_turtle04_pose", "-o", "./result_bags/result_bag_{}_{}".format(i, r)], stdout=sp.PIPE, stderr=sp.STDOUT)
