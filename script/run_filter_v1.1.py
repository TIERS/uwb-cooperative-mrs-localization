...
for i in [0,2]:
    for r in tqdm.tqdm(range(num_rounds)):
        ...
        time.sleep(0.1)
        p1 = sp.Popen(["python", "pfilter_ros2_uwb_position_multi_robots_v3.0.py", "--fuse_group", "{}".format(i), "--round", "{}".format(r)], stdout=sp.PIPE, stderr=sp.STDOUT)
        ...
        p3 = sp.Popen(["ros2", "bag", "record",  "/tri_turtle01_pose", "/tri_turtle03_pose", "/tri_turtle04_pose", "/real_turtle01_pose", "/real_turtle03_pose",
                 "/real_turtle04_pose", "/real_turtle05_pose", "/pf_turtle01_pose","/pf_turtle03_pose", "/pf_turtle04_pose", "-d", "100", "-o", "./result_bags/{}/result_bag_{}_{}".format(bag_file, i, r)], stdout=sp.PIPE, stderr=sp.STDOUT)
