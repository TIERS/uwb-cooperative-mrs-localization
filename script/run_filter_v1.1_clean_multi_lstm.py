...
for bag_file in bag_files:
    ...
    for i, fus in enumerate(fusion): 
        ...
        for r in tqdm.tqdm(range(num_rounds)):
            ...
            time.sleep(0.1)
            p1 = sp.Popen(["python", "pfilter_ros2_uwb_position_multi_robots_v5.0_lstm.py", "--fuse_group", "{}".format(i), "--round", "{}".format(r)], stdout=sp.PIPE, stderr=sp.STDOUT)
            ...
            time.sleep(1)
    ros2 bag record  /tri_turtle01_pose /tri_turtle02_pose /tri_turtle03_pose /tri_turtle05_pose /real_turtle01_pose /real_turtle02_pose /real_turtle03_pose /real_turtle04_pose /real_turtle05_pose /pf_turtle01_pose /pf_turtle02_pose /pf_turtle03_pose /pf_turtle05_pose -o pf_u
print("------ END ------")