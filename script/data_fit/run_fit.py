...
p0 = sp.Popen(["ros2", "bag", "play", "recorded_data/20221011/4robots_data_02"], stdout=sp.PIPE, stderr=sp.STDOUT)
time.sleep(0.1)
p1 = sp.Popen(["python", "bias_estimation_multiple2.py"], stdout=sp.PIPE, stderr=sp.STDOUT)
